...
const   Todo=() => {
  ...
  return (
   <div className='bg-white place-self-center w-11/12 max-w-md flex flex-col p-7 min-h-[550px] rounded-xl'>
    ...
    <input ref={inputRef} className="bg-transparent border-0 outlinr-none flex-1 h-14 pl-6 pr-2 placeholder:text-slate-600" type="text" placeholder="Add yout task"/>
